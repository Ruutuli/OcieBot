...
import qotdAnswerRoutes from './routes/qotdAnswers';
import promptRoutes from './routes/prompts';
import promptAnswerRoutes from './routes/promptAnswers';
...
app.use('/api/qotd-answers', qotdAnswerRoutes);
app.use('/api/prompts', promptRoutes);
app.use('/api/prompt-answers', promptAnswerRoutes);
